	...
	for (i=0; i<manikinIDs.length; i++){
		...
		$.ajax({
			...
			error: function (request, status, error) {
				...
				if (population=='nhanes'){
					img_directory = './data/fetcher/img_nhanes/'+gender_+'/';
					cad_directory = './data/fetcher/cad_nhanes/'+gender_+'/';
				} else if (population=='ansur'){
					img_directory = './data/fetcher/img_ansur/'+gender_+'/'+posture+'/';
					cad_directory = './data/fetcher/cad_ansur/'+gender_+'/'+posture+'/';
				}
				if (mView=='front'){
					manikinOutputHtml += '<img src="'+img_directory+imgFront[1]+'" style="max-width:100%">';
				} else if (mView=='side'){
					manikinOutputHtml += '<img src="'+img_directory+imgSide[1]+'" style="max-width:100%">';
				}
				...
				popupContents += '<img src="'+img_directory+imgFront[1]+'" style="float:left;max-width:50%">';
				popupContents += '<img src="'+img_directory+imgSide[1]+'" style="float:left;max-width:50%">';
				...
				popupContents += '<a href="'+img_directory+imgFront[1]+'" target="_blank" class="ui-btn ui-btn-inline">Front Image</a>';
				popupContents += '<a href="'+img_directory+imgSide[1]+'" target="_blank" class="ui-btn ui-btn-inline">Side Image</a>';
				popupContents += '<a href="'+cad_directory+cadFile[1]+'.fig" target="_blank" class="ui-btn ui-btn-inline">Jack (.fig)</a>';	
				popupContents += '<a href="'+cad_directory+cadFile[1]+'.jt" target="_blank" class="ui-btn ui-btn-inline">CAD (.jt)</a>';	
