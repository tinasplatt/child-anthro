...
if (sUnits=='mmkg'){
	...
	$.ajax({
		...
		url: "./data/getNearestNeighbors.php",
		...
		$.ajax({
			...
			success: function(data){
				...
				if (population=='nhanes'){
					...
					directory = 'ANSUR'+gender_+'Images';
				}
				if (mView=='front'){
					manikinOutputHtml += '<img src="../beta/images/'+directory+'/'+imgFront[1]+'" style="max-width:100%">';
				} else if (mView=='side'){
					manikinOutputHtml += '<img src="../beta/images/'+directory+'/'+imgSide[1]+'" style="max-width:100%">';
				}
				...
				popupContents = '<div class="ui-grid-a"><div class="ui-block-a" style="font-size:14px">';
					...
					popupContents += '<img src="../beta/images/'+gender_+'/'+imgFront[1]+'" style="float:left;max-width:50%">';
					popupContents += '<img src="../beta/images/'+gender_+'/'+imgSide[1]+'" style="float:left;max-width:50%">';
